...
public class CustomSmile extends View {
    ...
    public CustomSmile(Context context) {
        this(context, null);
    }

    public CustomSmile(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomSmile(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaints() {
        ...
        mEyeAndMouthPaint.setColor(Color.BLUE);
    }
    @Override
