...
public class Database extends SQLiteOpenHelper {
    ...
    private String TABLE_NAME = "Score";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String query = String.format("CREATE TABLE %s(%s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT, %s TEXT)", TABLE_NAME, KEY_ID, KEY_SCORE, KEY_TIME);
